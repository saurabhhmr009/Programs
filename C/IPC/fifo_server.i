...
# 4 "fifo_server.c"
    ...
    read_buff = (char*)malloc(1024*sizeof(char));
    write_buff = (char*)malloc(1024*sizeof(char));

    while(1) {
        fd = open("/tmp/fifo_comm.txt", 
# 16 "fifo_server.c" 3 4
                            00
# 16 "fifo_server.c"
                                    );
        ...
        fgets(write_buff, 1024, 
# 22 "fifo_server.c" 3 4
                                   stdin
# 22 "fifo_server.c"
                                        );
        fd = open("/tmp/fifo_comm.txt", 
# 23 "fifo_server.c" 3 4
                            01
# 23 "fifo_server.c"
                                    );
        write(fd, write_buff, 1024);
        close(fd);
    }
    return 0;
}
